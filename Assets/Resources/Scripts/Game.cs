...
public class Game : MonoBehaviour {
	...
	private static CameraBehaviour camera;
    ...
    {
		camera= GameObject.Find("/Main Camera").GetComponent<CameraBehaviour>();
        ...
        coracao = Resources.Load<Sprite>("Graphics/Sprites/Interface/coracao");
        coracao_damage = Resources.Load<Sprite>("Graphics/Sprites/Interface/coracao_damage");
    }
	...
	public static void CameraSetFollow(bool value) {
		camera.follow = value;
	}
}